...
(defmethod! Sound-Play ((s las-sound-data))
  :icon 207
  (when (ptr s)
...
(defmethod! sound-mix ((s1 las-sound-data) (s2 sound))
  (las-sound-mix s1 (get-las-sound-data s2)))

(defmethod! sound-mix ((s1 sound) (s2 las-sound-data))
...
(defmethod! sound-seq ((s1 las-sound-data) (s2 las-sound-data) &optional (crossfade 0))
    :icon 100
    :initvals '(nil nil 0)
