...
(defmethod make-new-pref-scroll ((num (eql :midi)) modulepref)
   ...
   (let ((thescroll (om-make-view 'preference-pane
     ...
     (om-add-subviews thescroll
                      (om-make-dialog-item 'om-static-text (om-make-point 20 (incf i 25)) (om-make-point 200 30) "MIDI system:"
                      ...
                      (om-make-dialog-item 'om-static-text (om-make-point 20 (incf i 40)) (om-make-point 150 24) "Default Ports:" :font *controls-font*)

                      (om-make-dialog-item 'om-static-text (om-make-point 160 i) (om-make-point 60 20) "Out" :font *controls-font*)
       
                      (om-make-dialog-item 'om-editable-text (om-make-point 190 i) (om-make-point 30 13)
                      ...
                      (om-make-dialog-item 'om-editable-text (om-make-point 260 i) (om-make-point 30 13)
